        ...
        <header class="bg-white shadow-sm border-b border-gray-100 sticky top-0 z-50">
            <nav class="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
                ...
                <div class="flex items-center gap-4">
                    @guest
                        <a href="{{ route('login') }}"
                            class="text-purple-600 hover:text-purple-700 font-semibold transition">
                            Iniciar Sesión
                        </a>
                        <a href="{{ route('register') }}"
                            class="px-6 py-2.5 bg-purple-600 hover:bg-purple-700 text-white font-semibold rounded-full transition shadow-md">
                            Registrarse
                        </a>
                    @else
                        <div x-data="{ open: false }" class="relative">
                            <button @click="open = !open"
                                ...
                                <img src="{{ auth()->user()->foto_perfil ? Storage::url(auth()->user()->foto_perfil) : asset('images/avatar.svg') }}"
                                    alt="Avatar" class="w-10 h-10 rounded-full ring-4 ring-purple-100 object-cover">
                            ...
                            <div x-show="open" @click.away="open = false"
                                class="absolute right-0 mt-3 w-64 bg-white rounded-2xl shadow-2xl border border-gray-100 py-3 overflow-hidden">
                                ...
                                @if(auth()->user()->is_admin)
                                    <a href="{{ route('dashboard') }}"
                                        class="block px-5 py-3 hover:bg-purple-50 text-gray-700 transition">
                                        Mi Panel
                                    </a>
                                @endif
                                ...
                                <form method="POST" action="{{ route('logout') }}" class="px-5">
                                    @csrf
                                    <button type="submit"
                                        class="w-full text-left py-3 text-red-600 hover:bg-red-50 rounded-lg transition font-medium">
                                        Cerrar sesión
                                    </button>
                                </form>
                            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div>
                        ...
                        <ul class="space-y-2">
                            <li><a href="{{ route('home') }}"
                                    class="text-gray-300 hover:text-white text-sm transition">Inicio</a></li>
                            <li><a href="{{ route('eventos.index') }}"
                                    class="text-gray-300 hover:text-white text-sm transition">Eventos</a></li>
                            <li><a href="{{ route('equipos.index') }}"
                                    class="text-gray-300 hover:text-white text-sm transition">Equipos</a></li>
                            <li><a href="{{ route('contact') }}"
                                    class="text-gray-300 hover:text-white text-sm transition">Contacto</a></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="flex gap-4">
                            <a href="#"
                                class="w-10 h-10 bg-slate-700 hover:bg-purple-600 rounded-full flex items-center justify-center transition">
